...
% dispositivos se mueven (en realidad, a medida que sus dueños humanos se mueven),
...
% grafos:
% 
% Afirmación: Sea G un gráfico en n nodos, donde n es un número par. Si cada nodo
