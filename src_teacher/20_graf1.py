graph = { "a" : ["c"],
          ...
          "c" : ["a", "b", "d", "e"],
          "d" : ["c"],
          "e" : ["c", "b"], # el vertice "e" tiene adyacente a "c" y "b"
          "f" : []  #El vértice f está aislado
        }
...
# 17 de mayo
print("Muestra las relaciones entre nodos sin que se repitan los vértices")
...
def find_isolated_nodes(graph):
  ...
  return isolated
print("Encuentra nodos aislados")
...
print("El grado de ", graph["c"], "es ", vertex_degree(graph, "c"))

def graph_degree(graph): # Calcula los grados de todos los ángulos del grafo
  # El grado de un vértice es el número de todos los lados adyacentes?
  degree_tot=0
  for vertex in graph:
    degree_tot=degree_tot+vertex_degree(graph,vertex)
  return degree_tot

print("El total de grados de grapgh es", graph_degree(graph))
